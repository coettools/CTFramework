...
Dark accents are cyan-blue #2ab0b5 and green #32cd32. Light variants use
darker counterparts for legibility. The fixture has no external fonts or runtime dependencies.
...
Browser checks:
- Check that all twelve surface/accent combinations preserve live search and the pinned design.
- Check text contrast for each surface/accent combination.
