...
export const DirectionCard = ({ Design, Selected, OnSelect, Index }) => html`
  <article class="direction-card">
    <div class="direction-heading">
      ...
      <h3>${Design.Name}</h3>
      ${Design.Id === "split" ? html`<span class="lab-tag">Framework default</span>` : null}
    </div>
    <div class="design-theme direction-sample" ${CT.Attr("data-surface", Design.Surface)} ${CT.Attr("data-accent", Design.Accent)} ${CT.Attr("data-shape", Design.Shape)} aria-hidden="true">
      ...
      <div class="sample-body">
        ...
        <div class="sample-content">
          <div class="sample-panel"><span>Component state</span><strong>03</strong><span class="sample-line"></span></div>
          <div class="sample-actions"><span>Primary</span><span>Secondary</span></div>
        </div>
      </div>
    </div>
